...
class Compressor:
    ...
    def compress_img(self, image_name, new_size_ratio=0.9, quality=90, width=None, height=None, to_jpg=True):
        ...
        if to_jpg:
            new_filename = f"{filename}_compressed_{self._random()}.jpg"
        else:
            new_filename = f"{filename}_compressed_{self._random()}{ext}"
